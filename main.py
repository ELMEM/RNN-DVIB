...
parser.add_argument('--Net_Type', default=['E'], choices={'O', 'E', 'P', 'T', 'C', 'F', 'M', 'K', 'L', 'k'},
                    help="Network Architecture. Convolution (C)"
                         "Transformers (T)")
# Transformers Parameters ------------------------------
parser.add_argument('--permute_data', default=False, action="store_false",
                    help='M-FCN class model default permute data')
